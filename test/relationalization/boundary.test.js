...
describe('Relationalization boundary audit: released Core 6.3.2', function () {
  ...
  before(async function () {
    ...
    try {
      session = await start();
      assert.strictEqual(session.metadata.coreVersion, '6.3.2', 'Re-audit after changing Core');
  ...
  // Deliberate baseline-loss witnesses. Passing these documents a gap in 6.3.2;
